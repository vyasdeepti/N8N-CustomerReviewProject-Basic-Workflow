...
### 📋 Form Trigger
Presents a feedback form collecting:
- 📧 Email ID (required)
- 👤 Name (required)
- 🎂 Age (required)
...
### 🔀 Conditional Check
The IF node evaluates whether feedback equals "Positive"
...
### 🔗 Merge
Combines both branches back into a single flow using append mode

### 📊 Google Sheets Logger
Appends every submission as a new row with all fields including the discount status
